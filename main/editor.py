...
def breeders_add():
    return breeders_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/breeders/delete', methods=['POST'])
def breeders_delete():
    return breeders_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/breeders/edit', methods=['POST'])
def breeders_edit():
    return breeders_actions.handle_edit(request, g.cursor, g.conn)
...
def kennels_add():
    return kennels_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/kennels/delete', methods=['POST'])
def kennels_delete():
    return kennels_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/kennels/edit', methods=['POST'])
def kennels_edit():
    return kennels_actions.handle_edit(request, g.cursor, g.conn)
...
def dogs_add():
    return dogs_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/dogs/delete', methods=['POST'])
def dogs_delete():
    return dogs_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/dogs/edit', methods=['POST'])
def dogs_edit():
    return dogs_actions.handle_edit(request, g.cursor, g.conn)

@bp.route('/dogs/<int:id>/add_exam', methods=['POST'])
def dogs_add_passed_exam(id):
    return dogs_actions.handle_add_passed_exam(request, g.cursor, g.conn, id)
...
def regions_add():
    return regions_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/regions/delete', methods=['POST'])
def regions_delete():
    return regions_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/regions/edit', methods=['POST'])
def regions_edit():
    return regions_actions.handle_edit(request, g.cursor, g.conn)
...
def breeds_add():
    return breeds_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/breeds/delete', methods=['POST'])
def breeds_delete():
    return breeds_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/breeds/edit', methods=['POST'])
def breeds_edit():
    return breeds_actions.handle_edit(request, g.cursor, g.conn)
...
def litters_add():
    return litters_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/litters/delete', methods=['POST'])
def litters_delete():
    return litters_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/litters/edit', methods=['POST'])
def litters_edit():
    return litters_actions.handle_edit(request, g.cursor, g.conn)
...
def exams_add():
    return exams_actions.handle_add(request, g.cursor, g.conn)

@bp.route('/exams/delete', methods=['POST'])
def exams_delete():
    return exams_actions.handle_delete(request, g.cursor, g.conn)

@bp.route('/exams/edit', methods=['POST'])
def exams_edit():
    return exams_actions.handle_edit(request, g.cursor, g.conn)